                    ...
                    <div class="col-lg-12">
                                    ...
                                    @foreach ($cart as $key => $item)
                                        <tr>
                                            ...
                                            <td class="pro-title"><a
                                                    href="{{ route('product.detail', $key) }}">{{ $item['name'] }}</a></td>
                                            <td class="pro-price">
                        ...
                        <div class="cart-update-option d-block d-md-flex justify-content-between">
                            <div class="apply-coupon-wrapper">
                                <form action="{{ route('cart.add') }}" method="post" class=" d-block d-md-flex">
