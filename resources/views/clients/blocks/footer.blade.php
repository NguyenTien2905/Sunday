            ...
            <div class="row align-items-center mt-20">
                ...
                <div class="col-md-6">
                    <div class="footer-payment">
                        <img src="/assets/client/img/payment.png" alt="payment method">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-lg-5">
                            <div class="product-large-slider">
                                <div class="pro-large-img img-zoom">
                                    <img src="/assets/client/img/product/product-details-img1.jpg"
                                        alt="product-details" />
                                </div>
                                <div class="pro-large-img img-zoom">
                                    <img src="/assets/client/img/product/product-details-img2.jpg"
                                        alt="product-details" />
                                </div>
                                <div class="pro-large-img img-zoom">
                                    <img src="/assets/client/img/product/product-details-img3.jpg"
                                        alt="product-details" />
                                </div>
                                <div class="pro-large-img img-zoom">
                                    <img src="/assets/client/img/product/product-details-img4.jpg"
                                        alt="product-details" />
                                </div>
                                <div class="pro-large-img img-zoom">
                                    <img src="/assets/client/img/product/product-details-img5.jpg"
                                        alt="product-details" />
                                </div>
                            </div>
                ...
                <div class="minicart-item-wrapper">
                    <ul>
                        <li class="minicart-item">
                            <div class="minicart-thumb">
                                <a href="product-details.html">
                                    <img src="/assets/client/img/cart/cart-1.jpg" alt="product">
                                </a>
                            </div>
                        ...
                        <li class="minicart-item">
                            <div class="minicart-thumb">
                                <a href="product-details.html">
                                    <img src="/assets/client/img/cart/cart-2.jpg" alt="product">
                                </a>
                            </div>
                            <div class="minicart-content">
                                <h3 class="product-name">
