                                    ...
                                    @foreach ($orders as $item)
                                        <tr>
                                            <td class="text-center">
                                                <a
                                                    href="{{ route('admins.orders.show', $item->id) }}">{{ $item->sku }}</a>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                @if ($item->status_order == $type_canceled )
                                                <form action="{{ route('admins.orders.delete', $item->id) }}"
