                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="sku" name="sku"
                                            ...
                                            value=" {{ old('sku') }}" placeholder="Mẫ sản phẩm">
                                        @error('sku')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" id="price_sale" name="price_sale"
                                            ...
                                            value="{{ old('price_sale') }}" placeholder="Giá khuyến mãi">
                                        @error('price_sale')
                                            <p class="text-danger mt-1">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" id="import_date" name="import_date"
                                            ...
                                            value="{{ old('import_date') }}" placeholder="Giá sản phẩm">
                                        @error('import_date')
                                            <p class="text-danger mt-1">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="discription" id="discription" class="form-control @error('discription') is-invaild @enderror"
                                            rows="3" placeholder="Mô tả ngắn">{{ old('discription') }}</textarea>
                                        @error('discription')
                                            <p class="text-danger mt-1">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <img id="img" src="" alt="Hình ảnh danh mục"
                                            ...
                                            <tbody id="image-table-body">
                                                <tr class="=">
                                                    <td class="d-flex align-item-center">
                                                        ...
                                                        <input type="file" id="image" name="list_images[id_0]"
                                                            placeholder="Hình ảnh danh mục" class="form-control"
