...
<head>
	...
	<!-- Favicon -->
	<link rel="shortcut icon" type="image/x-icon" href="/assets/auth/img/favicon.png">
	<!-- Bootstrap CSS -->
	...
	<!-- Flaticon CSS -->
	<link rel="stylesheet" href="/assets/auth/font/flaticon.css">
	<!-- Google Web Fonts -->
...
<body>
	...
	<section class="fxt-template-animation fxt-template-layout9" data-bg-image="/assets/auth/img/figure/bg9-l.jpg">
		<div class="container">
			<div class="row align-items-center justify-content-center">
				<div class="col-lg-3">
					<div class="fxt-header">
						<a href="login-9.html" class="fxt-logo"><img src="/assets/auth/img/logo-9.png" alt="Logo"></a>
					</div>
				</div>
				<div class="col-lg-6">
					@yield('content')
